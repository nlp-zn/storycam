...
<img src="./docs/design-docs/assets/storycam-core-storyboard.png" alt="StoryCam 核心分镜截图" width="100%">

## 实战学习资料

StoryCam 也是一个公开记录的 agentic full-stack build case study。学习资料和产品 UI 有意分离：普通用户看到的是私人小剧场工具，贡献者可以通过这些资料理解项目如何被设计、拆解、实现、上线和传播。
...
| 集数 | 标题 | 主题 |
| --- | --- | --- |
| 01 | 别先写代码！我用 AI Agent 先做产品设计 | 产品定位、私人小剧场方向、从需求前先定义问题。 |
...
很多 AI 视频工具要么只给一个空白提示词框，要么直接暴露专业生产工作台。StoryCam 选择一个更窄、更适合私人创作的产品闭环：
...
核心判断很简单：私人创作产品的信任来自“先确认，再生成”。用户应该先看到故事、人物和场景是对的，再让系统消耗视频生成成本。
