...
References are local context for agents. They are not product specs unless linked from `product-specs/` or an active plan.
...
- `shanyin-director-master-source.md` — provenance and StoryCam translation notes for the Shanyin Director Master reference.
- `shanyin-director-master/` — retained local snapshot of director methodology. Do not read by default; use only when internal director-methodology context is explicitly needed.
