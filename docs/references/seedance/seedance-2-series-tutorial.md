...
- Document title: Doubao Seedance 2.0 系列教程
- Original URL:
- Captured at:
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Windows 用户" key="yiuL5osJAy"><RenderMd content={`1. 进入 \`scripts/init_dev_env\` 目录。
...
<Tabs.TabPane title="macOS 用户" key="KJJLYZkBri"><RenderMd content={`1. 打开终端，进入 \`scripts/init_dev_env\` 目录。
2. 运行构建脚本：
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="PgL17KftiZ"><RenderMd content={`\`\`\`Python
import os
import time
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="SYfOsg3gNW"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="hSRbYlSyYI"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="BgjCqqfVNx"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="QlXn5KNLCX"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="zFEpqHAuNw"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="Y5CKRQ7W7A"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="YEtaiuoLqU"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="h0gVh3Y047"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="b3lXs0QY6n"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="gMUqgi9p4J"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="LRJkcrxVYu"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="Ik0q0bFtjo"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用预置虚拟人像](/docs/82379/2291680#2bf01416)示例生成的视频。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="fLXRCll4cM"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="CKBP9XmvoF"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="nJyaHBw9N7"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="SrTGzg08If"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="LFbYFP8p39"><RenderMd content={`\`\`\`Go
package main
